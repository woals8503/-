...
public class HouseController {
    ...
    @PostMapping("")
    public BaseResponse<HouseRegisterRes> createHouse(@RequestPart HouseReq houseReq, @RequestParam List<MultipartFile> houseImages
                                , @RequestParam List<MultipartFile> roomImages, @CurrentMember Member member) {
