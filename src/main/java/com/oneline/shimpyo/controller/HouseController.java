...
public class HouseController {
    ...
    @PostMapping("")
    public BaseResponse<HouseRegisterRes> createHouse(HouseReq houseReq, List<MultipartFile> houseImages
                                , List<MultipartFile> roomImages, @CurrentMember Member member) {
